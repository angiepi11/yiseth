			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a class="nav-link"  href="#" aria-controls="fruitsVegetable"><span
								 class="lnr lnr-arrow-right"></span>Computadores </span></a>
							 
								<!-- <li class="main-nav-list child"><a href="#">Accesorios</span></a></li> -->
						...
						<li class="main-nav-list"><a  class="nav-link"  href="#"  aria-controls="meatFish"><span
							 class="lnr lnr-arrow-right"></span>Celulares</a>
						...
						<li class="main-nav-list"><a  class="nav-link" href="#" ria-controls="cooking"><span
								 class="lnr lnr-arrow-right"></span>Tablets</a>
						...
						<li class="main-nav-list"><a class="nav-link" href="#" aria-controls="beverages"><span
								 class="lnr lnr-arrow-right"></span>Portatiles</a>
						...
						<li class="main-nav-list"><a href="#"  aria-controls="homeClean"><span
								 class="lnr lnr-arrow-right"></span>Almacenamiento</a>
						...
						<li class="main-nav-list"><a  href="#" aria-controls="officeProduct"><span
								 class="lnr lnr-arrow-right"></span>Accesorios</a>
				...
				<div class="sidebar-filter mt-50">
					<div class="top-filter-head">Filtro</div>
					<div class="common-filter">
						<div class="head">Marcas</div>
						<form action="#">
							<ul>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="apple" name="brand"><label for="apple">Apple<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="asus" name="brand"><label for="Xiaomi">Xiaomi<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="gionee" name="brand"><label for="Huawei">Huawei<span>(19)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="micromax" name="brand"><label for="Moto">Moto<span>(19)</span></label></li>
					...
					<div class="common-filter">
						...
						<form action="#">
							<ul>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="black" name="color"><label for="black">Azul<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="balckleather" name="color"><label for="balckleather">Blanco<span>(29)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="blackred" name="color"><label for="blackred">Negro<span>(19)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="gold" name="color"><label for="gold">Dorado<span>(19)</span></label></li>
				...
				<section class="lattest-product-area pb-40 category-list">
					...
					<?php foreach ($productos as $producto) : ?>
						...
						<!-- <div class="col-lg-4 col-md-6">
							...
							<img class="img-fluid" src="img/product/reloj1.webp" alt="">
							<div class="product-details">
								<h6>Reloj inteligente Alyas</h6>
								<div class="price">
									<h6>$150.000</h6>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="img/product/celular2.jpg" alt="">
							<div class="product-details">
								<h6>Huawei Mate pro50</h6>
								<div class="price">
									<h6>$150.00</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
							<img class="img-fluid" src="img/product/combo1.jpg" alt="">
							<div class="product-details">
								<h6>combo gamer 4 unitec</h6>
								<div class="price">
									<h6>$115.000</h6>
									<h6 class="l-through">$210.000</h6>
								</div>
					 ...
					 <div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="img/product/celular1.png" alt="">
							<div class="product-details">
								<h6>Huawei nova 10 pro</h6>
								<div class="price">
									<h6>$2.500.000</h6>
									<h6 class="l-through">$3.100.000</h6>
								</div>
								<div class="prd-bottom">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
							<img class="img-fluid" src="img/product/tablet2.jpeg" alt="">
							<div class="product-details">
								<h6>apple ipad air</h6>
								<div class="price">
									<h6>$5.000.000</h6>
									<h6 class="l-through">$.6000.000</h6>
								</div>
								<div class="prd-bottom">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
							<img class="img-fluid" src="img/product/soporte.webp" alt="">
							<div class="product-details">
								<h6>soporte para portatiles</h6>
								<div class="price">
									<h6>$50.000</h6>
									<h6 class="l-through">$80.000</h6>
								</div>
								<div class="prd-bottom">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="img/product/prod3.jpg" alt="">
							<div class="product-details">
								<h6>Computador Lenovo</h6>
								<div class="price">
									<h6>$2.000.000</h6>
