			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						<a href="<?php echo base_url().'inicio';?>">Inicio<span class="lnr lnr-arrow-right"></span></a>
	...
	<section class="login_box_area section_gap">
	  ...
	  <?php if (session ('nologin')):?>
        ...
        <script>
         ...
         icon: 'error',
         title:'0ops...',
         text: 'EL USUARIO O CONTRASEÑA  INCORRECTA, INICIE SESION DE NUEVO' })</script>
      <?php endif;?>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="<?php echo base_url().'registro';?>"> ¡Regístrate! </a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3> Inicia Sesion </h3>
						<form class="row login_form" action="<?php echo base_url().'guardarl';?>" method="post" id="loginususario" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="usuario" required placeholder="Usuario" onfocus="this.placeholder = ''"  onblur="this.placeholder = 'Usuario'">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="name"   name="clave" required placeholder="Contraseña" onfocus="this.placeholder = ''"  onblur="this.placeholder = 'Contraseña'">
							</div>
							<div class="col-md-12 form-group">
